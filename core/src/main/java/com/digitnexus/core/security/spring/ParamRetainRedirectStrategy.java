...
/**
 * Copy of {@link DefaultRedirectStrategy} with modification to retain param
 * @author Adi
 *
 */
public class ParamRetainRedirectStrategy implements RedirectStrategy {
	...
	public void sendRedirect(HttpServletRequest request, HttpServletResponse response, String url) throws IOException {
		...
		if(StringUtils.isNotEmpty(paramValue)){
			if(redirectUrl.contains("?")){
				redirectUrl=redirectUrl+"&"+paramName+"="+paramValue;
			}else{
				redirectUrl=redirectUrl+"?"+paramName+"="+paramValue;
			}
