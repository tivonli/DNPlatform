...
Actions.prototype.init = function()
{
	...
	var graph = editor.graph;
        ...
        //options actions
        this.addAction('preference', function() { 
            digitnexus.editor.me.openPreferences();
        });
       
	// File actions
	this.addAction('new', function() { 
            editor.newMashupDefinition();
            //window.open(ui.getUrl());
        });
	this.addAction('open', function()
	{
            editor.openMashupDefinitionList();
	});
	...
	this.addAction(digitnexus.editor.Constants.ED_ACTION_SAVE_MASHUP, function() { editor.saveMashupDefinition(); }, null, null, 'Ctrl+S');
        this.addAction(digitnexus.editor.Constants.ED_ACTION_NEW_MASHUP, function() { editor.newMashupDefinition(); }, null, null, 'Ctrl+N');
        this.addAction(digitnexus.editor.Constants.ED_ACTION_OPEN_MASHUP, function() { editor.openMashupDefinitionList(); }, null, null, 'Ctrl+O');
        this.addAction(digitnexus.editor.Constants.ED_ACTION_RUN_MASHUP, function() { editor.runMashupDefinition(); }, null, null, 'Ctrl+R');
        this.addAction(digitnexus.editor.Constants.ED_ACTION_OPEN_REPORTS, function() { editor.openReportPage(); }, null, null, 'Ctrl+R');
        
        this.addAction(digitnexus.editor.Constants.ED_ACTION_SAVE_AS_TEMPLATE, function() { editor.saveAsDefinitionTemplate(); }, null, null, 'Ctrl+S');
        this.addAction('save', function() { editor.saveMashupDefinition(); }, null, null, 'Ctrl+S');
	...
	this.addAction('help', function()
	{
		...
		window.open(TUTORIAL_PATH + '/index' + ext + '.html');
	});
	this.put('about', new Action(mxResources.get('about') + ' Mashup Editor', function()
	{
