...
EditorUi = function(editor, container)
{
	...
	{
             //digitnexus.editor.me.onExitEditor();
             digitnexus.editor.me.beforeExit();
	     if (editor.modified || digitnexus.editor.me.mashupInfoManager.isModified )
		{
...
EditorUi.prototype.refresh = function()
{
	...
	if (quirks)
	{
		...
		this.sidebarContainer.style.height = sidebarHeight + 'px';
                //this.propertyContainer.style.height = this.sidebarContainer.style.height;
	...
	else
	{
		this.sidebarContainer.style.bottom = (effVsplitPosition + this.splitSize + this.footerHeight) + 'px';
                // this.propertyContainer.style.bottom = this.sidebarContainer.style.bottom;
...
EditorUi.prototype.createDivs = function()
{
	...
	this.footerContainer = this.createDiv('geFooterContainer');
       ...
       // this.propertyContainer = this.createDiv('propertyBar');
	...
	this.footerContainer.style.bottom = '0px';
       ...
       // this.propertyContainer.style.top = this.sidebarContainer.style;
	//this.propertyContainer.style.right = '0px';
	//this.propertyContainer.style.bottom = '0px';
...
EditorUi.prototype.createUi = function()
{
	...
	this.sidebar = this.createSidebar(this.sidebarContainer);
        ...
        //this.property = this.createProperty(this.propertyContainer);
...
EditorUi.prototype.createProperty = function(container)
{
	return new Property(this, container);
};
...
/*
EditorUi.prototype.showPropertyDialog = function(elt, w, h, modal, closable, onClose)
{
	this.hideDialog();
	this.dialog = new PropertyMainDialog(this, elt, w, (mxClient.IS_VML) ? h - 12 : h, modal, closable, onClose);
};
*/
