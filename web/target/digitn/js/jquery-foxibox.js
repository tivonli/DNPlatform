 ...
 (function($) {
  $.fn.foxibox = function(settings) {
    ...
    $(window).resize(function(){
      ...
      //here is add some css to fixed bug id PT796
      changePrevAndNextShowOrHide(set_position,set_count);
    ...
    function changePrevAndNextShowOrHide(set_position,set_count){
    	if(set_position<=1){
      	  if($.browser.msie && $.browser.version <= 6){
      		  //IE support
      		  //here is will be fixed by css or other ...
      		  //TODO
      	  }else{
      		  $('#foxibox_nav #prev').addClass("foxibox_nav_prev_next_hide");
      	  }
        }else if(set_position>=set_count){
      	  if($.browser.msie && $.browser.version <= 6){
      		  //IE support
      		  //here is will be fixed by css or other ...
      		  //TODO
      	  }else{
      		  $('#foxibox_nav #next').addClass("foxibox_nav_prev_next_hide");
      	  }
        }
    }
    ...
    function changeImage(direction){
      ...
      //here is add some css to fixed bug id PT796
      $('#foxibox_nav #prev').removeClass("foxibox_nav_prev_next_hide");
      $('#foxibox_nav #next').removeClass("foxibox_nav_prev_next_hide");
      changePrevAndNextShowOrHide(set_position,set_count);
