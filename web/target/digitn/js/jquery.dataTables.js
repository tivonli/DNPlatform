...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnInitialise ( oSettings )
		{
			...
			for ( i=0, iLen=oSettings.aoColumns.length ; i<iLen ; i++ )
			{
				if ( (oSettings.aoColumns[i].sWidth !== null) && ( oSettings.aoColumns[i].sWidth !== '' ) )
				{
		...
		function _fnFeatureHtmlTable ( oSettings )
		{
			...
			if ( oSettings.oScroll.bAutoCss )
			{
				...
				nScrollBody.style.overflowX = "hidden";
			}
		...
		function _fnPageChange ( oSettings, sAction )
		{
			...
			if ( typeof sAction === "number" )
			{
				oSettings._iDisplayStart = sAction * oSettings._iDisplayLength;
				if ( oSettings._iDisplayStart > oSettings.fnRecordsDisplay() )
				{
					oSettings._iDisplayStart = 0;
				}
			}
			else if ( sAction == "first" )
			{
				oSettings._iDisplayStart = 0;
			}
