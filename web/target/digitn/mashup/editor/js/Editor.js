...
Editor = function()
{
	...
	this.status = '';
	digitnexus.editor.me.mashupEditor = this;   	       
        //digitnexus.editor.me.addEditableLisneter(this.graph.getModel())
	...
	if (cell != null){
		...
		if (node != null){
			...
			// window for later hiding of the window
                        //title, content, x, y, width, height, minimizable, movable, replaceNode, style
		     this.properties = new mxWindow(mxResources.get('properties',null,'properties'), node, x, y, 400, null, false,true,null,null);
                     this.properties.setVisible(true);
                     this.properties.setClosable(false);
...
Editor.prototype.createProperties = function(cell) {
        this.propertiesDialog = new digitnexus.editor.NodeProperties();
        return this.propertiesDialog.createProperties(cell);
}

Editor.prototype.saveMashupDefinition = function() {
    digitnexus.editor.me.mashupInfoManager.saveMashupDefinition();
}

Editor.prototype.saveAsDefinitionTemplate = function() {
    digitnexus.editor.me.mashupInfoManager.saveAsDefinitionTemplate();
}

Editor.prototype.newMashupDefinition = function() {
   // digitnexus.editor.me.saveMashupDefinition(this.getModel());
   digitnexus.editor.me.mashupInfoManager.createNewMashupDefinition(true);
}

Editor.prototype.openMashupDefinitionList = function() {
   digitnexus.editor.me.mashupInfoManager.openMashupDefinitionList(true);
}

Editor.prototype.runMashupDefinition = function() {
   digitnexus.editor.Report.prototype.getInstance().testReport();
}

Editor.prototype.openReportPage = function() {
   digitnexus.editor.Report.prototype.getInstance().openReportPage();
}
...
Editor.prototype.cleanCells = function(cells){
