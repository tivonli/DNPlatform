...
Menus.prototype.init = function()
{
	...
	{
		this.addMenuItems(menu, ['undo', 'redo','delete'/* '-', 'cut', 'copy', 'paste', 'delete', '-', 'duplicate', '-',
		                         'editLink', 'openLink', '-',
		                         'selectVertices', 'selectEdges', 'selectAll', '-', 'setAsDefaultEdge'*/]);
	})));
	this.put('window', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		//this.addMenuItems(menu, ['preference', 'guides', 'tooltips', '-', 'connect', 'navigation',
		//                         'scrollbars', '-', 'pageView', '-', 'pageBackgroundColor']);
                this.addMenuItems(menu, ['preference']);
	})));
...
Menus.prototype.createMenubar = function(container)
{
	...
	var menus = ['file','edit', 'window', 'help'/*, 'view', 'format', 'text', 'arrange', 'options', 'help'*/];
