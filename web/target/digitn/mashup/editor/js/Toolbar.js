...
Toolbar.prototype.init = function()
{
	this.addItems([/*'print',*/ 'undo', 'redo', 'delete'/*, '-', 'actualSize', 'zoomIn', 'zoomOut', '-'*/]);
        ...
        this.addItems([digitnexus.editor.Constants.ED_ACTION_SAVE_MASHUP,digitnexus.editor.Constants.ED_ACTION_SAVE_AS_TEMPLATE,
            digitnexus.editor.Constants.ED_ACTION_NEW_MASHUP,digitnexus.editor.Constants.ED_ACTION_OPEN_MASHUP,
            '-',digitnexus.editor.Constants.ED_ACTION_RUN_MASHUP,digitnexus.editor.Constants.ED_ACTION_OPEN_REPORTS]);
